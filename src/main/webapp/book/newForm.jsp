...
<body>
			...
			<form method="post" action="new" enctype="multipart/form-data">
			 ...
			 <table>
			 	...
			 	<tr>
			 		<!-- 사용자가 선택한 이미지 파일이 서버에 없로드 되도록 한다. form 태그에 enctype 속성 -->
					<th><label>책 커버(이미지파일첨부)</label></th>
			 		...
			 		<!-- 웹에서 파일형식 MIME 으로 설정. 이미지 파일 선택 accept 속성 설정 
			 			파일 선택 대화상자에 모든파일이 있으므로 추가로 자바스크랩트에서 확장자 체크하는 함수 필요.
			 			필요에 따라 파일 타입 input 을 여러개 사용하거나 또는,
			 			multiple="multiple" 설정은 동시에 여러개 파일 선택 가능하고 컨트롤러에서는
			 			이것을 Enumeration타입으로 받는다.
			 			https://velog.io/@virtualplastic/JSP-Servlet-%EC%97%AC%EB%9F%AC-%EA%B0%9C%EC%9D%98-%ED%8C%8C%EC%9D%BC%EC%9D%84-%ED%95%9C%EB%B2%88%EC%97%90-%EC%97%85%EB%A1%9C%EB%93%9C
			 		-->
			 	</tr>
